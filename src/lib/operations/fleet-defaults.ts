  ...
  const crew: FleetStore["crew"] = [
    {
      id: "crew-marcus",
      name: "Marcus T.",
      roles: ["skipper", "driver", "mover"],
      active: true,
      teamMemberId: "tm_6",
      bio: "8 years with Jonah's — leads crews on local and long-distance moves. Loves tight stairwell puzzles.",
    ...
    },
    {
      ...
      roles: ["skipper", "driver", "mover"],
      active: true,
      bio: "Skipper since 2019. Calm under pressure and great with customers on move day.",
      showOnCustomerPortal: true,
    },
    {
      id: "crew-devon",
      ...
      active: true,
      teamMemberId: "tm_5",
      bio: "Former carpenter — extra careful with antiques and fragile items.",
      showOnCustomerPortal: true,
    },
